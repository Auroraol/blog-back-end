...
public class DateIntervalUtils {
	 ...
	 * @return 包含最近两周日期的列表
	 */
	public static List<String> getNearlyTwoWeeksDates() {
		SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
		Calendar c = Calendar.getInstance();
		// 当前日期
		String today = format.format(new Date());
...
//		String end = format.format(c.getTime());
		List<String> result = getBetweenDates(start, today, false);
		return result;
	}
	...
	public static void main(String[] args) {
		...
		List<String> nearlyTwoWeeksDates = DateIntervalUtils.getNearlyTwoWeeksDates();
	}
